...
> Current status (2026-08-01): the reproduced eligibility material below is stale and retained only as historical advisory context. It is not authoritative eligibility guidance. Every derived claim-window date, guarantee indication, service rule, exclusion, urgency, or expiry signal is labeled unverified advisory or policy-review-required. It cannot block a valid `LATE_CANDIDATE` or definitively mark a claim expired. Canada Post must confirm the current policy.
