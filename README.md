...
Current public stable version: **0.4.5** for Linux x64 and Windows x64. Version **0.4.6** is the current release candidate. `OPERATING_GUIDE.md` is the authoritative operator guide; development checkpoint reports remain historical.
