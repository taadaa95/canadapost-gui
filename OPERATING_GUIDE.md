...
| Linux artifact | `Canada.Post.Claim.Runner-0.4.4-linux-x86_64.AppImage` |
| Windows artifact | `Canada.Post.Claim.Runner-0.4.4-win-x64.exe` |
| macOS artifact | `Canada.Post.Claim.Runner-0.4.4-mac-universal.dmg` (publish only if Developer ID signed and notarized) |
