...
| Linux artifact | `Canada.Post.Claim.Runner-0.4.5-linux-x86_64.AppImage` |
| Windows artifact | `Canada.Post.Claim.Runner-0.4.5-win-x64.exe` |
| macOS artifact | `Canada.Post.Claim.Runner-0.4.5-mac-universal.dmg` (publish only if Developer ID signed and notarized) |
