...
emit_event('tracking_start', array('total' => $totalRows, 'trackingCsv' => $csvFile, 'claimsCsv' => $claimsFile, 'deliverySource' => 'GetTrackingSummary', 'requestIntervalMs' => $trackingRequestIntervalMs));
