...
function preview(options = {}) {
  ...
  return {
    ...
    exclusions: [
      ...
      'screenshots', 'private signing keys', 'full tracking numbers', 'addresses and contact details'
    ],
    warning: 'Review the generated archive before sharing it. Opt-in logs and operational summaries are sanitized but may still reveal business context.'
  };
}
