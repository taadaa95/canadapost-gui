...
const CONFIG_KEYS = keySet(`
  ...
  claimContactName claimContactPhone claimContactEmail evidenceRetentionDays dryRunDefault setupCompleted setupSafetyAcknowledged locale
...
const RUN_KEYS = new Set([...CONFIG_KEYS, ...keySet(`
  ...
  selectedTrackingNumbers selectedClassificationRecords canaryMode liveSubmissionConfirmed portalCompatibilityOverride diagnosticMode
