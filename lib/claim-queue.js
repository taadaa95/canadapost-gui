...
function claimInputFromRow(row, settings = {}) {
  const storedClassificationInput = parseJsonCell(firstValue(row, ['Classification Input JSON', 'classificationInputJson']), null);
  if (storedClassificationInput?.trackingNumber) return storedClassificationInput;
