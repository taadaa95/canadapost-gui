...
function validateSubmitOptions(input = {}) {
  ...
  return {
    ...
    browserMode,
    dryRun: strictBoolean(source.dryRun, { fallback: false, code: 'SUBMIT_DRY_RUN_INVALID', field: 'dryRun' }),
    developerMode: false,
    ...
    liveSubmissionConfirmed: strictBoolean(source.liveSubmissionConfirmed, { fallback: false, code: 'SUBMIT_CONFIRMATION_INVALID', field: 'liveSubmissionConfirmed' }),
    portalCompatibilityOverride: strictBoolean(source.portalCompatibilityOverride, { fallback: false, code: 'PORTAL_COMPATIBILITY_OVERRIDE_INVALID', field: 'portalCompatibilityOverride' }),
